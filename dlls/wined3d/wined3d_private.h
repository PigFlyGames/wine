...
HRESULT surface_copy_data(struct wined3d_surface *surface, BYTE *data, UINT row_pitch, BOOL srgb) DECLSPEC_HIDDEN;
HRESULT surface_load_data(struct wined3d_surface *surface, BYTE *data, UINT row_pitch, BOOL srgb) DECLSPEC_HIDDEN;
